  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); // music-95dc8.appspot.com
        const songsRef = storageRef.child(`songs/${file.name}`); // music-95dc8.appspot.com/songs/example.mp3
        // console.log('storage_ref');
        // console.log(storageRef);

        // console.log('songs_ref');
